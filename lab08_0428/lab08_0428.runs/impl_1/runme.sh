...
HD_PWD='D:/Xilinx/lab08_0428/lab08_0428.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log check_1sec.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source check_1sec.tcl -notrace
