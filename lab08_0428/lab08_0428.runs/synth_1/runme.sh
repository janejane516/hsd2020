...
HD_PWD='D:/Xilinx/lab08_0428/lab08_0428.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log check_1sec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source check_1sec.tcl
